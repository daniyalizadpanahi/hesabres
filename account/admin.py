...
class CustomUserAdmin(admin.ModelAdmin):
    list_display = ('national_id', 'name', 'last_name', 'phone_number', 'is_active', 'is_staff', 'created_at')
...
class LoanAdmin(admin.ModelAdmin):
    list_display = ('borrower', 'guarantor', 'amount', 'monthly_installment', 'total_months', 'paid_months', 'is_active', 'created_at')
    search_fields = ('borrower__account_number', 'guarantor__account_number', 'guarantor_info')
    list_filter = ('is_active',)
